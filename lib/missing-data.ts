...
export const MISSING_PIECE_TEAMS: MissingPieceTeamData[] = [
  {
    ...
    joueurs: [
      ...
      { nom: "Kanté", prenom: "N'Golo", poste: "MID", numero: 13, posX: 50, posY: 55 },
      { nom: "Griezmann", prenom: "Antoine", poste: "MID", numero: 7, posX: 30, posY: 52 },
  ...
  },
  {
    ...
    joueurs: [
      ...
      { nom: "Di María", prenom: "Ángel", poste: "FWD", numero: 11, posX: 80, posY: 28 },
  ...
  },
  {
    ...
    joueurs: [
      ...
      { nom: "A. Silva", prenom: "Antonio", poste: "DEF", numero: 14, posX: 38, posY: 75 },
      { nom: "N. Mendes", prenom: "Nuno", poste: "DEF", numero: 19, posX: 15, posY: 72 },
      { nom: "Vitinha", prenom: "", poste: "MID", numero: 23, posX: 70, posY: 52 },
      { nom: "B. Silva", prenom: "Bernardo", poste: "MID", numero: 10, posX: 50, posY: 55 },
      { nom: "B. Fernandes", prenom: "Bruno", poste: "MID", numero: 8, posX: 30, posY: 52 },
      { nom: "R. Leão", prenom: "Rafael", poste: "FWD", numero: 17, posX: 80, posY: 28 },
      { nom: "Ronaldo", prenom: "Cristiano", poste: "FWD", numero: 7, posX: 50, posY: 22 },
      { nom: "F. Conceição", prenom: "Francisco", poste: "FWD", numero: 21, posX: 20, posY: 28 },
    ],
  ...
  },
  {
    ...
    joueurs: [
      ...
      { nom: "Kroos", prenom: "Toni", poste: "MID", numero: 8, posX: 62, posY: 55 },
