...
export const SCOUT_TEAMS: ScoutTeamData[] = [
  ...
  },
  {
    ...
    joueurs: [
      ...
      { nom: "Wirtz", club: "Bayer Leverkusen", poste: "MID", posX: 50, posY: 55 },
      { nom: "Musiala", club: "Bayern Munich", poste: "MID", posX: 30, posY: 52 },
      { nom: "Sané", club: "Bayern Munich", poste: "FWD", posX: 80, posY: 28 },
  ...
  },
  {
    ...
    joueurs: [
      ...
      { nom: "Reijnders", club: "AC Milan", poste: "MID", posX: 60, posY: 55 },
      { nom: "de Jong", club: "FC Barcelone", poste: "MID", posX: 40, posY: 55 },
      { nom: "Simons", club: "RB Leipzig", poste: "MID", posX: 20, posY: 50 },
  ...
  },
  {
    ...
    joueurs: [
      ...
      { nom: "Faes", club: "Leicester City", poste: "DEF", posX: 62, posY: 75 },
  ...
  },
  {
    ...
    joueurs: [
      ...
      { nom: "Hashioka", club: "Luton Town", poste: "DEF", posX: 15, posY: 72 },
