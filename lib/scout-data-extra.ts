...
export const EXTRA_TEAMS: ScoutTeamData[] = [
...

  {
    pays: "Égypte", drapeau: "🇪🇬", formation: "4-3-3", joueurs: [
      { nom: "El-Shenawy", club: "Al Ahly", poste: P.GK, ...pos.gk }, { nom: "Ashour", club: "Al Ahly", poste: P.DEF, ...pos.rb }, { nom: "Hegazi", club: "Al-Ittihad", poste: P.DEF, ...pos.rcb }, { nom: "Abdelmonem", club: "Beşiktaş", poste: P.DEF, ...pos.lcb }, { nom: "Fatouh", club: "Zamalek", poste: P.DEF, ...pos.lb }, { nom: "Elneny", club: "Al Jazira", poste: P.MID, ...pos.rm }, { nom: "Fathi", club: "Al Ahly", poste: P.MID, ...pos.cm }, { nom: "Trezeguet", club: "Al Ahly", poste: P.MID, ...pos.lm }, { nom: "Salah", club: "Liverpool", poste: P.FWD, ...pos.rw }, { nom: "Marmoush", club: "Manchester City", poste: P.FWD, ...pos.st }, { nom: "Adel", club: "Pyramids FC", poste: P.FWD, ...pos.lw }]
  },

  {
    pays: "Algérie", drapeau: "🇩🇿", formation: "4-3-3", joueurs: [
      { nom: "Mandréa", club: "RC Lens", poste: P.GK, ...pos.gk }, { nom: "Atal", club: "Al-Sadd", poste: P.DEF, ...pos.rb }, { nom: "Mandi", club: "Villarreal CF", poste: P.DEF, ...pos.rcb }, { nom: "Tougai", club: "Espérance de Tunis", poste: P.DEF, ...pos.lcb }, { nom: "Aït-Nouri", club: "Manchester City", poste: P.DEF, ...pos.lb }, { nom: "Bennacer", club: "AC Milan", poste: P.MID, ...pos.rm }, { nom: "Aouar", club: "Al-Ittihad", poste: P.MID, ...pos.cm }, { nom: "Chaïbi", club: "Eintracht Frankfurt", poste: P.MID, ...pos.lm }, { nom: "Mahrez", club: "Al-Ahli", poste: P.FWD, ...pos.rw }, { nom: "Gouiri", club: "Stade Rennais", poste: P.FWD, ...pos.st }, { nom: "Amoura", club: "VfL Wolfsburg", poste: P.FWD, ...pos.lw }]
  },
...

  {
    pays: "Côte d'Ivoire", drapeau: "🇨🇮", formation: "4-3-3", joueurs: [
      { nom: "Fofana", club: "Çaykur Rizespor", poste: P.GK, ...pos.gk }, { nom: "Singo", club: "Galatasaray", poste: P.DEF, ...pos.rb }, { nom: "Kossounou", club: "Atalanta", poste: P.DEF, ...pos.rcb }, { nom: "Ndicka", club: "AS Roma", poste: P.DEF, ...pos.lcb }, { nom: "Konan", club: "Gil Vicente", poste: P.DEF, ...pos.lb }, { nom: "Kessié", club: "Al-Ahli", poste: P.MID, ...pos.rm }, { nom: "S. Fofana", club: "FC Porto", poste: P.MID, ...pos.cm }, { nom: "Sangaré", club: "Nottingham Forest", poste: P.MID, ...pos.lm }, { nom: "Diallo", club: "Manchester United", poste: P.FWD, ...pos.rw }, { nom: "Adingra", club: "AS Monaco", poste: P.FWD, ...pos.st }, { nom: "Guessand", club: "Aston Villa", poste: P.FWD, ...pos.lw }]
  },
