        ...
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              {/* Active glow */}
              {isActive && (
                <div className="absolute -top-px left-1/2 h-[2px] w-8 -translate-x-1/2 rounded-full bg-emerald-500 dark:bg-emerald-400 shadow-[0_0_8px_rgba(16,185,129,0.3)] dark:shadow-[0_0_8px_rgba(52,211,153,0.6)]" />
              )}
