    ...
    <article className="mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24">
      <div className="text-center">
        ...
        <h1 className="text-4xl font-black tracking-tight text-white sm:text-5xl">
          ...
          <span className="bg-gradient-to-r from-[#FFE600] to-amber-300 bg-clip-text text-transparent">un mondial historique</span>
        </h1>
      ...
      <div className="mt-14 space-y-12 text-base leading-relaxed text-zinc-300">
        ...
        <section className="space-y-4">
          <h2 className="flex items-center gap-3 text-2xl font-black text-white">
            <Users className="h-7 w-7 text-[#00FF87]" /> 48 équipes : un format inédit
          </h2>
        ...
        <section className="space-y-4">
          <h2 className="flex items-center gap-3 text-2xl font-black text-white">
            <MapPin className="h-7 w-7 text-[#FF007F]" /> Trois pays hôtes
          </h2>
        ...
        <section className="space-y-4">
          <h2 className="flex items-center gap-3 text-2xl font-black text-white">
            <Calendar className="h-7 w-7 text-[#FFE600]" /> Dates clés
          </h2>
          <div className="space-y-3">
            <div className="flex items-center gap-4 rounded-lg border border-zinc-800 bg-zinc-900/50 px-5 py-3">
              <span className="shrink-0 text-sm font-bold text-[#00FF87]">11 juin 2026</span>
              <span className="text-sm text-zinc-400">Match d&apos;ouverture — Estadio Azteca, Mexico</span>
            </div>
            <div className="flex items-center gap-4 rounded-lg border border-zinc-800 bg-zinc-900/50 px-5 py-3">
              <span className="shrink-0 text-sm font-bold text-[#FFE600]">Juin - Juillet</span>
              <span className="text-sm text-zinc-400">Phase de groupes (12 groupes de 4)</span>
            </div>
            <div className="flex items-center gap-4 rounded-lg border border-zinc-800 bg-zinc-900/50 px-5 py-3">
              <span className="shrink-0 text-sm font-bold text-[#FF007F]">Juillet 2026</span>
              <span className="text-sm text-zinc-400">Phase à élimination directe</span>
            </div>
            <div className="flex items-center gap-4 rounded-lg border border-zinc-800 bg-zinc-900/50 px-5 py-3">
              <span className="shrink-0 text-sm font-bold text-[#FFE600]">19 juillet 2026</span>
        ...
        <section className="space-y-4">
          <h2 className="flex items-center gap-3 text-2xl font-black text-white">
            <Trophy className="h-7 w-7 text-[#FFE600]" /> Les favoris du tournoi
          </h2>
        ...
        <section className="space-y-4">
          <h2 className="flex items-center gap-3 text-2xl font-black text-white">
            <Gamepad2 className="h-7 w-7 text-[#00FF87]" /> FootQuest et la Coupe du Monde 2026
          </h2>
          ...
          <p>Notre design s&apos;inspire directement de l&apos;identité visuelle du mondial avec des couleurs néon vibrantes : <strong className="text-[#00FF87]">vert</strong>, <strong className="text-[#FF007F]">magenta</strong> et <strong className="text-[#FFE600]">jaune</strong>, qui reflètent l&apos;énergie et la modernité de cet événement historique.</p>
      ...
      <div className="mt-16 rounded-xl border border-zinc-800 bg-gradient-to-r from-zinc-900 to-zinc-900/50 p-8 text-center">
        ...
        <div className="mt-6">
          <Link href="/signup" className="group inline-flex items-center gap-2 rounded-xl bg-[#00FF87] px-8 py-3 text-sm font-bold text-zinc-950 transition-all hover:-translate-y-0.5 hover:shadow-[0_0_15px_rgba(0,255,135,0.4)]">
